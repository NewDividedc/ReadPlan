...
//
    ...
    fun initdata(){
        ...
        val user1=User("汉青堂","13456","https://img1.doubanio.com/icon/u145458142-9.jpg")
        val user2=User("炎樱","13456","https://img9.doubanio.com/icon/u16235694-135.jpg")
        val user3=User("D君","13456","https://img2.doubanio.com/icon/u1484677-13.jpg")
        val user4=User("Scorpio|千寻","13456","https://img9.doubanio.com/icon/u3034854-75.jpg")
        val user5=User("NewDividedc","13456","https://img2.baidu.com/it/u=2951542358,3634590085&fm=11&fmt=auto&gp=0.jpg")
